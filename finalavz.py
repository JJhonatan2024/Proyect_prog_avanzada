...
pagina = st.sidebar.radio(
    ...
    options=["Inicio","Residuos Domiciliarios por Departamento","Residuos No Domiciliarios por Departamento",
             "Residuos Municipales por Departamento","Análisis por Provincia y Tipo de Residuo","Análisis por Departamento y Año",
...
# --------------------------------
# Análisis per cápita por Provincia y Tipo de Residuo
# --------------------------------
if pagina == "Análisis por Provincia y Tipo de Residuo":
    st.title("Residuos per cápita por Distrito")
    st.markdown("Selecciona un departamento, una provincia, un año y el tipo de residuo para ver la generación por persona.")
    # Filtros adicionales para este analisis en el sidebar
...
if pagina == "Crecimiento Porcentual por Departamento":
    ...
    st.markdown("""Este análisis muestra el crecimiento porcentual de residuos generados por departamento entre los años 2014 y 2022.""")
    # Selectbox para el tipo de residuo de este analisis
